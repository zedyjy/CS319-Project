...
const loginnavbarTemplate = document.createElement("template");

loginnavbarTemplate.innerHTML = `
  <style>
...
class loginnavbar extends HTMLElement {
    ...
    connectedCallback() {
        ...
        shadowRoot.appendChild(loginnavbarTemplate.content);
...
customElements.define("loginnavbar-component", loginnavbar);
